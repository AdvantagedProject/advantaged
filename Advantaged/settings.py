"""
Django settings for Advantaged project.
...
SECRET_KEY = '@#y^4xe30)4wx$0jkz@plf&ir!^gxor%mygb-n4o8e*8i93$x_'
...
WSGI_APPLICATION = 'Advantaged.wsgi.application'
